...
public:
	...
	HRESULT GetTexture2D(ComPtr<ID3D12Resource>& resource, const UINT width, const UINT height, const UINT arrayDepth, const DXGI_FORMAT format = DXGI_FORMAT_R32_FLOAT, const D3D12_RESOURCE_STATES initialState = D3D12_RESOURCE_STATE_ALL_SHADER_RESOURCE, const D3D12_RESOURCE_FLAGS flags = D3D12_RESOURCE_FLAG_NONE);
};